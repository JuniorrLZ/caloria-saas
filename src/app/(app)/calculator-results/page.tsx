        ...
        <div className="min-h-[80vh] flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-[2rem] p-8 md:p-10 shadow-lg border border-slate-100">
                <header className="mb-8 text-center">
                    ...
                    <h2 className="text-xl font-semibold text-slate-800 mb-2">Your Results</h2>
                    <p className="text-slate-500 text-sm">Based on your profile and goals, here&apos;s your personalized plan</p>
                </header>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-6 text-center border border-indigo-200">
                        <p className="text-xs font-semibold text-indigo-400 uppercase tracking-wider mb-2">Your BMI</p>
                        <h3 className="text-4xl font-bold text-indigo-600">24.5</h3>
                        <span className="inline-flex items-center mt-2 px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">Normal Weight</span>
                    </div>
                    <div className="bg-gradient-to-br from-sky-50 to-sky-100 rounded-2xl p-6 text-center border border-sky-200">
                        <p className="text-xs font-semibold text-sky-400 uppercase tracking-wider mb-2">Basal Metabolic Rate</p>
                        <h3 className="text-4xl font-bold text-sky-600">1,540</h3>
                        <p className="text-xs text-sky-500 mt-1">kcal / day</p>
                    </div>
                </div>

                {/* Daily Goals */}
                <div className="bg-slate-50 rounded-2xl p-6 mb-6 border border-slate-100">
                    <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2"><Target className="w-5 h-5 text-[var(--color-primary)]" /> Daily Calorie Goal</h3>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="bg-[var(--color-primary)]/10 text-[var(--color-primary)] text-xs font-bold px-3 py-1 rounded-full">Maintenance</span>
                    </div>
                ...
                <div className="bg-blue-50 rounded-2xl p-6 mb-6 border border-blue-100 flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-800">Water Intake</h3>
                        <p className="text-slate-600 text-sm">Recommended: <span className="font-bold text-blue-600">2,500 ml / day</span></p>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-sky-50 rounded-2xl p-6 mb-6 border border-indigo-100">
                    ...
                    <p className="text-sm text-slate-700 leading-relaxed">
                        Based on your profile, we recommend focusing on a <span className="font-semibold text-indigo-600">high-protein, moderate-carb</span> approach.
                        This will help maintain your current weight while supporting muscle recovery from your exercise routine.
                        Consider timing your carbs around your workout window for optimal energy.
                    </p>
                </div>
                ...
                <p className="text-center text-xs text-slate-400 mt-4">
                    Results are based on the Mifflin-St Jeor equation. Consult a professional for personalized advice.
                </p>
            </div>
        </div>
    );
